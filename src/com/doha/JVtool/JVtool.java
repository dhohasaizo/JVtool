...
public class JVtool extends Activity {
	static int count = 0;
	...
	class MyHandler extends Handler {
		public void doWork(String str, final Bundle bundle) {
			...
			if (bundle.getBoolean("isTemp")) {  
				...
				SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(JVtool.this);
				...
				if (settings.getBoolean("notify", false) != false) {
					...
					Intent notificationIntent = JVtool.this.getIntent();
					PendingIntent contentIntent = PendingIntent.getActivity(
							JVtool.this, 0, notificationIntent, 0);
...
//				tasks[num] = false;
//				dialogs[num].dismiss();
				Toast.makeText(JVtool.this, str, Toast.LENGTH_LONG)
						.show();
				...
				if (settings.getBoolean("wrap_msg", true) == false) {
					HorizontalScrollView hscv = new HorizontalScrollView(
							JVtool.this);
					ScrollView scv = new ScrollView(JVtool.this);
					TextView tv;

					tv = new TextView(JVtool.this);
	...
	public void threadWork(Context context, String message,
		...
		if (!tasks[0])
			...
			freeTask = 3;
		if (freeTask == -1) {
			Toast.makeText(JVtool.this, getString(R.string.nofreetask),
			...
			public void run() {
				...
				try {
					...
					os.writeBytes(new String(
							"LD_LIBRARY_PATH=/data/data/com.doha.JVtool/apktool/openjdk/lib/i386:/data/data/com.doha.JVtool/apktool/openjdk/lib/i386/jli:/data/data/com.doha.JVtool/apktool/openjdk/lib/arm:/data/data/com.doha.JVtool/apktool/openjdk/lib/arm/jli:$LD_LIBRARY_PATH ")     	//Note:This line is very important!
							+command + "\n");
					os.writeBytes("exit\n");
					os.flush();
...
//						bundle.putInt("tasknum", tasknum);
		...
		myDialog.setButton(DialogInterface.BUTTON_POSITIVE,
		  ...
		  @Override public void onClick(DialogInterface dialog, int which) {
			  RunExec.Cmd(shell, "sh /data/data/com.doha.JVtool/apktool/killjob.sh");
...
//		tasks[freeTask] = true;
	...
	protected Dialog onCreateDialog(int id) {
		...
		switch (id) {
		case DECODE:
			return new AlertDialog.Builder(JVtool.this).setItems(
					R.array.dec_array, new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
							String apktoolVersion = PreferenceManager.getDefaultSharedPreferences(JVtool.this)
																		   .getString("apktool_version", "2.0.1");
							String diff = "";
							if(apktoolVersion.equals("2.0.1")){
								apktoolVersion = "sh /data/data/com.doha.JVtool/apktool/apktool2.sh ";
								diff = " -o ";
							}else
								apktoolVersion = "sh /data/data/com.doha.JVtool/apktool/apktool.sh ";
							switch (which) {
							case decode_all:
								...
								case decode_res:
									...
									threadWork(JVtool.this, getString(R.string.decompiling), command3, 4);								
									break;							
								case sign_apk:		
									final String command4 = new String("sh /data/data/com.doha.JVtool/apktool/signapk.sh ") 
										+ "'" + uri + "' '" + uri.substring(0, uri.length() - 4) + "_sign.apk'";
									threadWork(JVtool.this, getString(R.string.signing), command4, 1);					
									break;
								case make_odex:								
									final String command5 = new String(" /data/data/com.doha.JVtool/apktool/openjdk/bin/dexopt-wrapper ") 
										+ "'" + uri + "' '" + uri.substring(0, uri.length() - 3) + "odex'";
									threadWork(JVtool.this, getString(R.string.making), command5, 6);	
									break;

								case zipalign:
									final String command7 = new String("/data/data/com.doha.JVtool/apktool/openjdk/bin/zipalign -f 4 ") + "'" + uri + "' '" + uri.substring(0, uri.length() - 4) + "_zipalign.apk'";
									threadWork(JVtool.this, getString(R.string.aligning), command7, 8);
									break;
								case install:
								...
								case delete_dex:
									...
									final String command9 = new String("sh /data/data/com.doha.JVtool/apktool/7z.sh '")+new File(uri).getParent()+"' d -tzip '" + uri + "' classes.dex";
									threadWork(JVtool.this, getString(R.string.deleting), command9, 10);
									break;
								case extract_sign:
									
									if (!new File(new File(uri).getParent() + "/META-INF").exists())
									{
										final String command10 = new String("sh /data/data/com.doha.JVtool/apktool/7z.sh '")  + new File(uri).getParent() + "' x -tzip '" + uri+ "' META-INF";
										threadWork(JVtool.this, getString(R.string.unpacking), command10, 6);
									}
									else
										Toast.makeText(JVtool.this, getString(R.string.dir_exist), Toast.LENGTH_LONG).show();
									break;
								case delete_sign:
									
									final String command11 = new String("sh /data/data/com.doha.JVtool/apktool/7z.sh '")+new File(uri).getParent()+"' d -tzip " + "'" + uri + "'" + " META-INF";
									threadWork(JVtool.this, getString(R.string.deleting), command11, 10);
									break;
								case add_sign:
									...
									if (new File(str + "/META-INF").exists())
									{
										...
										final String command12 = new String("sh /data/data/com.doha.JVtool/apktool/7z.sh '")+str+"' a -tzip '" + uri + "' '" + str + "/META-INF'";
										threadWork(JVtool.this, getString(R.string.adding), command12, 9);}
									else
										Toast.makeText(JVtool.this, getString(R.string.dir_not_exist), Toast.LENGTH_LONG).show();
									break;
								case import_fw:
									final String command13 = apktoolVersion+" if " + "'" + uri + "'";								
									threadWork(JVtool.this, getString(R.string.importing_framework), command13, 7);
									break;
								
							case dex2jar:
								if(uri.endsWith(".apk")){
								final String command15 = new String("sh /data/data/com.doha.JVtool/apktool/dex2jar/d2j-dex2jar.sh ")
								+ "'"
								+uri
								+"' -o '"
								+uri.substring(0,uri.length()-3)
								+"jar'";
								threadWork(JVtool.this,getString(R.string.making),command15,6);
								}
								break;
							case jar2dex:
								if(uri.endsWith(".jar")){
									final String command16 = new String("sh /data/data/com.doha.JVtool/apktool/dex2jar/d2j-jar2dex.sh ")
									+ "'"
									+uri
									+"' -o '"
									+uri.substring(0,uri.length()-3)
									+"dex'";
									threadWork(JVtool.this,getString(R.string.making),command16,6);
									}
									break;
							case decode_cancel:
								return;
			...
			return new AlertDialog.Builder(JVtool.this).setItems(
					R.array.comp_array, new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
							String apktoolVersion = PreferenceManager.getDefaultSharedPreferences(JVtool.this)
									   .getString("apktool_version", "2.0.1");
							String aaptVersion = PreferenceManager.getDefaultSharedPreferences(JVtool.this)
									   .getString("aapt_version", "4.4");
							if(aaptVersion.equals("Doha"))
								aaptVersion = " Doha ";
							else
								aaptVersion = " /data/data/com.doha.JVtool/apktool/openjdk/bin/aapt" + aaptVersion;
							...
							case 0:
								if (uri.endsWith("_src")) {
									...
									final String command0 = new String(
											"sh /data/data/com.doha.JVtool/apktool/smali.sh -a ")
											+ apicode
											+ " '"
											+ uri
											+ "' -o '"
							...
							case 1:
								...
								if(tmp.listFiles()==null){
									Toast.makeText(JVtool.this,getString(R.string.directory_no_permission),Toast.LENGTH_LONG).show();									
								}
								else{
									currentParent = tmp;
									currentFiles = currentParent.listFiles();
			...
			return new AlertDialog.Builder(JVtool.this).setItems(
					...
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
							...
							case 0:
								final String command0 = new String(
										"sh /data/data/com.doha.JVtool/apktool/baksmali.sh -x -a ")
										+ apicode
										+ " '"
										+ uri
										+ "' -o '"
								...
								break;
							case 1:
									final String command1 = new String("sh /data/data/com.doha.JVtool/apktool/signodex.sh ") + uri;
									threadWork(JVtool.this, getString(R.string.signing), command1, 1);
									break;									
							case 2:
								return;
							}
			...
			return new AlertDialog.Builder(JVtool.this).setItems(
					...
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
							...
							case 0:
								final String command0 = new String(
										"sh /data/data/com.doha.JVtool/apktool/baksmali.sh '")
										+ uri
										+ "' -o '"
										+ uri.substring(0, uri.length() - 4)
										+ "_dex'";
							...
							case 1:
								...
								if (new File(apkFile).exists()) {
									apkFile = uri.substring(0, uri.length() - 3)
											+ "apk";
									RunExec.Cmd(shell,
											new String("/data/data/com.doha.JVtool/busybox cp '") + uri + "' '"
													+ new File(uri).getParent()
													+ "/classes.dex'");
									final String command1 = new String(
											"sh /data/data/com.doha.JVtool/apktool/7z.sh '")+new File(uri).getParent()+"' a -tzip '"
													+ apkFile + "' '"
													+ new File(uri).getParent()
													+ "/classes.dex'";
									threadWork(JVtool.this,
					...
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
							...
							case 0:
								...
								new AlertDialog.Builder(JVtool.this)
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							case 0:
								if (uri.endsWith("boot.img")) {
									File tmp = new File(uri);
									final String command0 = new String(
											" busybox sh /data/data/com.doha.JVtool/apktool/unpackimg.sh '")
											+ tmp.getParent()
					...
					R.array.repackimg, new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
							...
							case 0:
								...
								File tmp = new File(uri);
								final String command0 = new String(
										" busybox  sh /data/data/com.doha.JVtool/apktool/repackimg.sh '")
			...
			return new AlertDialog.Builder(JVtool.this).setItems(
					...
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
							...
							case 0:
								final String command0 = new String(
										" /data/data/com.doha.JVtool/lix/jvm/java-7-openjdk-armel/bin/javac '")+ uri+ "'";
								threadWork(JVtool.this,
										getString(R.string.recompiling),
										command0, 5);
								break;
					...
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
							...
							case 0:
								...
								file = tmp.getName();
								final String command0 = new String(
										" /data/data/com.doha.JVtool/lix/jvm/java-7-openjdk-armel/jre/bin/java -cp '")
	...
	public void onCreate(Bundle savedInstanceState) {
		SharedPreferences settings1 = PreferenceManager.getDefaultSharedPreferences(JVtool.this);
		if (settings1.getBoolean("root", false) != false) {
			shell = "su ";
			RunExec.Cmd("su ","setenforce 0"); //Disable selinux to avoid permission denied.
			RunExec.Cmd("su ","chmod 755 /data/data/com.doha.JVtool/lib/libld.so");
		}
		else {
			shell = "sh ";
		}
		...
		RunExec.Cmd(shell,"/data/data/com.doha.JVtool/busybox mount -o remout,rw /");
...
//		RunExec.Cmd(shell, "chmod 777 /cache");
		...
		*/
		...
		RunExec.Cmd(shell,"ln -s /data/data/com.doha.JVtool/lib/libb.so /data/data/com.doha.JVtool/busybox");
		RunExec.Cmd(shell,"/data/data/com.doha.JVtool/busybox rm -r /data/data/com.doha.JVtool/apktool");
		RunExec.Cmd(shell, "/data/data/com.doha.JVtool/busybox tar xpf /data/data/com.doha.JVtool/lib/libjdk.so --directory=/data/data/com.doha.JVtool/");			
		RunExec.Cmd(shell, "/data/data/com.doha.JVtool/busybox chmod -R 755 /data/data/com.doha.JVtool/apktool");
		if(!new File("/data/data/com.doha.JVtool/apktool").exists())	{	
			RunExec.Cmd(shell, "busybox tar xpf /data/data/com.doha.JVtool/lib/libjdk.so --directory=/data/data/com.doha.JVtool/");			
			RunExec.Cmd(shell, "busybox chmod -R 755 /data/data/com.doha.JVtool/apktool");
		}
		
		Intent intent = new Intent(Intent.ACTION_VIEW);  
		final Uri apkuri = Uri.fromFile(new File("/data/data/com.doha.JVtool/apktool/JVtool.apk"));  
		intent.setDataAndType(apkuri, "application/vnd.android.package-archive");  
		startActivity(intent);
		finish();
		...
		if (settings.getBoolean("showAgreement",true) == true) {
			AlertDialog.Builder agreeDialog = new AlertDialog.Builder(JVtool.this);
...
//		RunExec.Cmd(shell, "busybox mount -o remount,exec /cache");
		/*
		if (!new File("/data/data/com.doha.JVtool/mydata").exists()) {
			if (new File("/data/data/com.doha.JVtool/apktool").exists()) {
				
				RunExec.Cmd(shell,
						"ln -sf /data/data/com.doha.JVtool/apktool /data/data/com.doha.JVtool/mydata");
				extractData();
			} else {
	...
	private void inflateListView(File[] files) {
		...
		for (int i = 0; i < files.length; i++) {
			...
			if (files[i].isDirectory()) {
				listItem.put("icon",
						getFileIcon(JVtool.this, files[i].getAbsolutePath(), fileType.FOLDER));
			} else if (files[i].getName().endsWith(".apk")) {
				listItem.put(
						"icon",
						getFileIcon(JVtool.this,
								files[i].getAbsolutePath(), fileType.APKFILE));

			} else if (files[i].getName().endsWith(".odex")) {
				listItem.put("icon",
						getFileIcon(JVtool.this, null, fileType.ODEXFILE));

			}	else if (files[i].getName().endsWith(".img")) {
					listItem.put("icon",
								 getFileIcon(JVtool.this, null, fileType.IMGFILE));
						
			}	else if (files[i].getName().endsWith(".zip")) {
				listItem.put("icon",
							 getFileIcon(JVtool.this, null, fileType.ZIPFILS));
			   ...
			   || files[i].getName().endsWith(".xml")
				...
				listItem.put("icon",
							 getFileIcon(JVtool.this, null, fileType.TXTFILE));
							 
            }	else if (files[i].getName().endsWith(".jar")) {
	            listItem.put("icon",
					getFileIcon(JVtool.this, null, fileType.JARFILE));
	   
			}	else if (files[i].getName().endsWith(".tar")) {
				listItem.put("icon",
							 getFileIcon(JVtool.this, null, fileType.TARFILE));
				
			}	else if (files[i].getName().endsWith(".dex")) {
				listItem.put("icon",
							 getFileIcon(JVtool.this, null, fileType.DEXFILS));
				
			}	else if (files[i].getName().endsWith(".java")) {
				listItem.put("icon",
							 getFileIcon(JVtool.this, null, fileType.JAVAFILE));
							 
			}	else if (files[i].getName().endsWith(".class")) {
				listItem.put("icon",
							 getFileIcon(JVtool.this, null, fileType.CLASSFILE));
							 
			}	else if (files[i].getName().endsWith(".sh")) {
				listItem.put("icon",
							 getFileIcon(JVtool.this, null, fileType.SHELLFILE));
				
			} else {
				listItem.put("icon",
						getFileIcon(JVtool.this, null, fileType.NFILE));
			} 
		...
		case R.id.about:
			...
			.setPositiveButton(getString(R.string.visit),new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface paramAnonymousDialogInterface,
					...
					intent.setData(Uri.parse("https://github.com/dhohasaizo/JVtool"));
					startActivity(intent);
		}
	})
...
//			return false;
		...
		case R.id.rom:
			...
			.setPositiveButton(getString(R.string.ok),new DialogInterface.OnClickListener() {
				public void onClick(
						...
						int paramAnonymousInt) {
							uri = "update.zip";
							final String cmd = new String(" busybox sh /data/data/com.doha.JVtool/apktool/genscript.sh");
							threadWork(JVtool.this, getString(R.string.making_rom), cmd, 6);
				}
			})
		...
		case R.id.setting:
			...
			return false;
		case R.id.diagnose:
			RunExec.Cmd(shell, "sh /data/data/com.doha.JVtool/apktool/diagnose.sh");
	...
	public Drawable getFileIcon(Context context, String path, fileType type) {
		...
		case APKFILE:
			...
			PackageManager pm = JVtool.this.getPackageManager();
...
/*
	public void extractData() {
		new Thread() {
			public void run() {
				if (!(new File("/data/data/com.doha.JVtool/lix").exists())) {
					RunExec.Cmd(shell, "dd if=/data/data/com.doha.JVtool/apktool/busybox of=/data/data/com.doha.JVtool/tar");
					RunExec.Cmd(shell, "chmod 777 /data/data/com.doha.JVtool/tar");
					RunExec.Cmd(shell, "/data/data/com.doha.JVtool/tar xf /data/data/com.doha.JVtool/apktool/jvm.tar --directory=/data/data/com.doha.JVtool");	
					RunExec.Cmd(shell, " cp /data/data/com.doha.JVtool/apktool/busybox /data/data/com.doha.JVtool/lix");
					RunExec.Cmd(shell, "chmod -R 755 /data/data/com.doha.JVtool/lix");
					RunExec.Cmd(shell, " rm /data/data/com.doha.JVtool/tar");
				}
			}
		}.start();
	}
